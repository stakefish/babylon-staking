...
import { ErrorType, ShowErrorParams } from "@/ui/types/errors";
import { getCommitHash } from "@/ui/utils/version";
...
export const ErrorModal: React.FC = () => {
  ...
  return (
    ...
    >
      <DialogBody className="text-accent-primary py-16 mb-4 text-center">
