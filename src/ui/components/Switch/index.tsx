  ...
  <div className="flex items-center gap-2 select-none">
    ...
    >
      <SwitchPrimitives.Thumb
        className={cx(
          "pointer-events-none block size-[18px] rounded-full bg-backgroundPrimaryDefault shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-[13px] data-[state=unchecked]:translate-x-0",
        )}
      />
    </SwitchPrimitives.Root>
    {rightLabel && (
